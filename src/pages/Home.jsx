...
export default function Home() {
  return (
    <div className="homie p-8  mx-auto bg-gray-50 rounded-lg shadow-lg">
      ...
      <div className=" ml-23 text-left">
        <h2 className="text-xl  font-semibold mb-4 pl-5 text-white">
          Still an Student
        </h2>
        ...
        <p className="pt-2 pl-1 md:pt-2 md-pl-5">&nbsp;&nbsp;&nbsp;I am a student with a vision of success, an entrepreneurial mindset, and the drive to achieve my goals. Starting from scratch, I am determined to reach them. I am currently working as a freelancer, and I am excited to see how far I will go in the next five years.</p>
      </div>
    ...
    ></a>
            ...
            <h1 className="pl-2">Pet-Location, Grade 12 Capstone, This Research, aim for the safety of our pet.</h1>
          </div>
          </div>
      </div>
    </div>
